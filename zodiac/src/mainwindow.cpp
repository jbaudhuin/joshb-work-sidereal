...
MainWindow::showAbout()
{
    ...
    l2->setText(
        ...
        "<p><b>GeoNames Geographical Data</b><br>"
        "City and administrative-division data from GeoNames<br>"
        "Licensed under CC BY 4.0<br>"
        "<a style='color:yellow' href='https://www.geonames.org/'>www.geonames.org</a><br>"
        "See data/geonames-readme.txt for details</p>"
